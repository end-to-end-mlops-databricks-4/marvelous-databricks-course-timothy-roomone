...
class HotelReservationModelWrapper(mlflow.pyfunc.PythonModel):
    ...
    This class wraps a machine learning model for predicting Hotel Reservation cancellations.
    """
...
class CustomModel:
    """Custom model class for hotel reservation cancellation prediction.
